...
class TransactionList extends StatelessWidget {
  ...
  List<PaymentTransaction> get _sortedTransactions {
    if (!sortByCreatedAt) return transactions;

    // Sort by createdAt in descending order (newest first)
    final sorted = List<PaymentTransaction>.from(transactions)
      ..sort((a, b) {
              ...
              child: sortedTransactions.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return TransactionCard(paymentTransaction: transaction);
                      },
                    ),
            ),
          ],
      ...
      child: Column(
        ...
        children: [
          ...
          ...displayTransactions.map(
            (transaction) => TransactionCard(paymentTransaction: transaction),
          ),
